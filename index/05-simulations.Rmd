...
> would it be better to have the models section before this? i.e. lit review-> data motivation->models->normal simulation->hierarchical simulation->data analysis-> conclusion 
...
> I don't think I need this paragraph about HPD since it is addressed in the later parts, but maybe I should move the proper methods section up before this
