...
OR.runall<-function(snp.name, discovery.sitenames, iter=5000,p = 0.00325, psdir="ps"){
  ...
  p53.sim = jags(data=p53.data, inits=NULL,n.iter=5000,n.chains=5, parameters.to.save =parameters, model = p53.model)
  p53.simnew = jags(data=p53.data , inits=NULL,n.iter=5000,n.chains=5, parameters.to.save =parameters, model = p53.newmodel) 
  p53.simnormal = jags(data=p53.data.normal, inits=NULL,n.iter=5000,n.chains=5, parameters.to.save =parameters.normal, model = p53.normal)
  p53.bfsim = jags(data=bfdata, inits=function(){list("pind"=.9)},n.iter=5000,n.chains=5, parameters.to.save =parameters, model = p53.bf.approx)
