...
>what is an appropriate length for conclusions?
...
These frameworks can also be applied to non-normal data and more complicated models, especially for joint analysis that can account for interactions between the p53 SNP's and other factors. 

> not sure how specific/detailed this section should be
