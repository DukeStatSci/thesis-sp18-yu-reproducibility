...
\begin{alltt}
\hlstd{knitr}\hlopt{::}\hlstd{opts_chunk}\hlopt{$}\hlkwd{set}\hlstd{(}\hlkwc{message} \hlstd{=} \hlnum{FALSE}\hlstd{,} \hlkwc{warning} \hlstd{=} \hlnum{FALSE}\hlstd{,} \hlkwc{cache}\hlstd{=}\hlnum{TRUE}\hlstd{,}\hlkwc{echo}\hlstd{=}\hlnum{FALSE}\hlstd{)}
\hlstd{mu}\hlkwb{<-}\hlstd{I}\hlkwb{<-}\hlstd{sd}\hlkwb{<-}\hlstd{overall}\hlkwb{<-}\hlkwa{NULL}


\hlkwd{library}\hlstd{(rmeta)}
\end{alltt}
